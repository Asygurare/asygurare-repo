...
import { Plus, MessageSquare, Trash2, Clock, Check, Edit2, ChevronDown } from 'lucide-react'
  ...
  return (
    <div className="w-full md:w-80 h-full bg-white rounded-[2rem] sm:rounded-[3rem] p-4 sm:p-6 flex flex-col border border-black/5 shadow-xl">
      ...
      <button
        ...
        className="w-full flex items-center justify-between gap-2 mb-4 px-2 text-black/30 hover:text-black/60 transition-colors"
        aria-expanded={isExpanded}
        aria-label="Desplegar historial reciente"
      >
