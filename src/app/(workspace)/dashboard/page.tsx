...
export default function DashboardPage() {
  ...
  const cards = [
    { label: 'Primas Totales', value: `$${stats.primas.toLocaleString()}`, color: 'text-black', icon: TrendingUp, detail: 'Cartera total', link: "/polizas" },
    { label: 'Clientes Activos', value: stats.clientes.toString(), color: 'text-(--accents)', icon: Users, detail: 'Cuentas registradas', link: "/clientes" },
    { label: 'Pólizas a Renovar', value: stats.renovaciones.toString(), color: 'text-orange-600', icon: FileCheck, detail: 'Próximos 30 días', link: "/pagos" },
    { label: 'Oportunidades Lead', value: stats.leads.toString(), color: 'text-blue-600', icon: Sparkles, detail: 'En seguimiento', link: "/prospectos" },
  ]
